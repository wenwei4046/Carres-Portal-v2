...
comment on column public.orders.proceeded_at is
  ...
  'proceed_order; cleared only by governed un-proceed back to place. 0391.';
...
comment on column public.orders.sales_final_submitted_at is
  ...
  'rental and imported orders. Automatic handoff retries require this fact. 0391.';
...
-- grant during the database-first compatibility window: 0391 must be safe while
...
comment on function public.recover_legacy_sales_final_submits(uuid[],text) is
  ...
  'historical backlog is closed. 0391.';
