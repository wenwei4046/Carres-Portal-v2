-- =============================================================================
-- 0403 · Operations Superuser uses the one PO-issue authority
-- =============================================================================
...
comment on function public.is_operations_superuser(uuid) is
  '0403: governed operational capability. Principal (Jess) and explicitly flagged accounts may act without inheriting PO Duty ownership.';
...
comment on function public.purchasing_actor_may_issue(uuid) is
  '0403: the one PO issue capability — current duty, dated cover, or governed Operations Superuser.';
...
comment on function public.purchasing_record_po_issue_authority() is
  '0403: atomically records actual PO issuer plus normal duty and dated cover context for every purchase_order insert.';
