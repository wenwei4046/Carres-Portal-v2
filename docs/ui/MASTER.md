...
2. **Date and identity — APPROVED / NOT BUILT (Jess, 2026-09-17).** Every listing begins
   ...
   SO Batch `Proceed Date · SO No`; Manual Purchase `Proceed Date · PO No` (approved target, Purchasing §9.2;
   blank before issue, Items opens the request and PO references open their own POs); Purchase Orders `PO Date · PO No`; Receiving `GRN Date · GRN No`;
