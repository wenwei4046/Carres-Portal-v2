...
**Files:**
- Create: `supabase/migrations/0407_the_supplier_answer_never_rewrites_the_po.sql`
...
```bash
git add supabase/migrations/0407_the_supplier_answer_never_rewrites_the_po.sql packages/shared/src/purchasing-po-authority.test.ts packages/shared/src/purchase-order-evidence.test.ts
