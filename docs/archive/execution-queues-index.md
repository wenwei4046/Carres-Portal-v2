...
|---|---|---|---|
| **R10** | `docs/purchasing/MASTER.md` | **docs only** — `docs/purchasing/MASTER.md` §9 | tiny |
| **Q14** | `docs/purchasing/MASTER.md` | Purchase Orders + api | small |
| **P5** | `docs/purchasing/MASTER.md` | **writes no code** — walks the chain and reports | verification |
| **R9** | `docs/purchasing/MASTER.md` | Claims + migration | medium |
| **R11** | `docs/purchasing/MASTER.md` | Claims + the resolution engine | medium |
| **R12** | `docs/purchasing/MASTER.md` | Claims + migration | medium |
| **P7** | `docs/purchasing/MASTER.md` | To Order — a full rewrite | **large, and LAST** |
...
| **`Confirm ready date` moves to Purchase Orders** — queue and door in one place | `docs/purchasing/MASTER.md` head |
...
confirmation and refuse the DOCUMENT instead, which is what `orders/MASTER.md` §5 has
...
`docs/purchasing/MASTER.md`. **The engine itself was already built** — the P-cards
...
- **The transfer-route master data went with the old master spec (D0.4, 2026-07-28) and is
  ...
  transfer, not purchasing** (purchasing/MASTER.md), so the card belongs to Stock.
...
(`orders/MASTER.md`) is the template; each further module gets
...
Read orders/MASTER.md. Do card J1 ONLY. ...
Read docs/service-case-execution-queue.md. Do card S1 ONLY. ...
Read docs/purchasing/MASTER.md. Do card R1 ONLY. ...
Read docs/ready-stock-execution-queue.md. Do card K1 ONLY. ...
Read docs/purchasing/MASTER.md. Do card P1 ONLY. ...
Read orders/MASTER.md. Do card C2 ONLY. ...
```
...
```
Read docs/purchasing/MASTER.md — the "LOO UNFROZE To Order" block and card P8.
...
```
Read docs/purchasing/MASTER.md — the "LOO UNFROZE To Order" block and card P9.
