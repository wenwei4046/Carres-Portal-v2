...
> 5. `docs/purchasing/MASTER.md` — Purchasing reference *(corrected 2026-07-29: `purchase-cockpit-handoff.md` deleted 2026-07-27)*
> 6. `orders/MASTER.md` — Orders integration (subscription SO type lives there)
