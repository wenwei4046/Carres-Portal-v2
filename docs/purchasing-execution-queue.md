...
| P14 | 🔨 **CLAIMED 2026-08-04 — `claude/p14-move-dialog-ef40de`** · **`CreatePurchaseDialog` moves to its own file** — a PURE move, zero behaviour. It lives inside `OperationToOrder.tsx` (line 1359+) and two lanes are about to edit that one file; **that is exactly how P10 got built twice.** DO THIS FIRST | — |
