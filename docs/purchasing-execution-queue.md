...
**TWO PATHS, and they are the two he ruled:**
...
the goods actually went. **The list of paths is Loo's and this card may not extend it**; a
third enters `RECEIVING-INFORMATION-MODEL.md` §1.2 only when he rules it, and §1.2's recorded
*"顾客去我们厂那边"* remark is a business fact, not a path.
