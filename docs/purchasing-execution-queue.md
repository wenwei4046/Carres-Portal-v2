...
| P17 | ⬜ **the grid gets its column separators** — Loo ruled it 2026-08-05 from two photographs of the live page, seconds apart. Measured: all seven cells carry `border-right: 0px`. The floating group band, the broken-looking whitespace and the tiring page are ONE cause. **KIT — four pages change at once.** No colour invented | — |
