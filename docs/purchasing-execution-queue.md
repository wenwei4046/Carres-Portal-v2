...
| P9 | 🔨 CLAIMED 2026-08-04 — `claude/card-p9-purchasing-queue-3da49e` · **the page says how many of each you are buying** (Loo 2026-08-04) — CATEGORY rows carry bare unit counts; a footer totals the ticked rows. Rail + footer regions only | — |
