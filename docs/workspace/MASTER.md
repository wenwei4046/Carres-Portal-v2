...
- Payment collection now enters from the complete issued-Invoice register, not a second Sales Order
  ...
  Delivery Operation, established from the order's own recorded customer-contact owner (0487),
  else the Delivery Duty holder when collection first became actionable, and kept until the
  balance is RM 0 (0489 · 0495, owner ruling 2026-09-13) — owns the action
