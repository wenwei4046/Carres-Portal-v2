...
| Monitor footer / empty / scoped-empty | **`{n} orders · RM {x} balance due`** · **`No customer money is needed right now.`** · **`No follow-up planned on {day}.`** · **`SO-{n} needs no payment right now. Its money is in Payment Records.`** | — |
