...
| Create / returned-request edit sections (owner 2026-09-22; APPROVED / NOT BUILT) | `Request Details` → `Delivery` → `Items`; identical order in the 50/50 internal MPR preview. This is not a supplier PO. Saved-object sections below remain separate. |
