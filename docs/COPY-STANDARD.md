...
| Supplier row labels | `PO Delivery Date` · `Latest date` · `Delay reason` · `Evidence` · `Supplier DO` · `Deliver to` · `GRN` · `{n} of 4 complete` · `Open {PO No}` · `Open Purchasing` · `Supplier details could not be loaded.` | Stock received |
