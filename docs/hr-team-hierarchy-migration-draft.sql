-- DRAFT — hr_team_hierarchy (2026-07-25, Loo: "Phase 1 — HR Team hierarchy").
-- Number assigned at apply time AFTER `list_migrations` tail check (guardrail #8).
-- Draft lives in docs/ until Loo approves; never in supabase/migrations/ before that.
--
