...
| ⑦ Purchasing | `docs/purchasing-execution-queue.md` | P1-P5 | **P1 ✅ #488** (0303 — the numbers became settings) · **P2 ✅ #492 + #494 + #495** — the click law is true on all three Purchasing lists (To Order · Claims · Receiving) · **P3 ✅ #503** (0306 — the two supplier calls, and a balance date enters Delay planning too). **P4 is the next card** |
...
⑦ **P1 ✅ · P2 ✅ · P3 ✅** · ⑧ D0 + T1 + T2 + **D0.5a + D0.5b** ✅ (**Q1/Q3/Q4 FROZEN 2026-07-28 — the PENDING REGISTER is empty**; T3 is still a Jess task, not a build card). **Next on ⑧: D0.5c** — `PageShell` + `DataTable` + `DetailShell`.
...
**Purchasing lane, 2026-07-29: FREE again. ⑦ P3 took it and released it (#503).** Before that:
...
**What P3 changed (2026-07-29, PR #503, migration 0306).** The two supplier calls §3 names and
...
✅ P3            the two supplier calls   #503   (0306)
