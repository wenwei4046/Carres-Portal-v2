...
⑦ **P1 ✅ · P2 ✅ · P3 ✅** · ⑧ D0 + T1 + T2 + **D0.5a + D0.5b + D0.5c** ✅ (**Q1/Q3/Q4 FROZEN 2026-07-28 — the PENDING REGISTER is empty**; T3 is still a Jess task, not a build card). **D0.5c ✅ CLOSED as components-only** (`PageShell` · `DataTable` · `DetailShell`; the drawer is not migrated — PM, 2026-07-29). **Next on ⑦: P4. On ⑧: D0.6 ✅ · D1 ✅ · D2 ✅ · D3 🔨 CLAIMED 2026-07-29 — branch `claude/carres-portal-d3-execution-0be46e`, PM approved Option A = Phase 1 (the ruler) + Phase 2 (15 deterministic hex conversions) ONLY. Phase 3 (`--primary` flame → blue, 613 sites) and Phase 4 (`base-*` → kit palette, 4,577 sites) are NOT in it and each needs its own card.**
