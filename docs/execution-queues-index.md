...
| ⑥ Portal Core | `docs/portal-core-execution-queue.md` | C1-C10 | **C1 ✅ #461 · C2 ✅ #466 · C5 ✅ #447 · C9 ✅ #472** · Jess rulings 2026-07-27 (Dynamic Checklist · Chase banned) |
...
customer confirmed) · ⑤ K0 #376 + K1 #400 ✅ · ⑥ **C1 ✅ #461 · C2 ✅ #466 · C5 ✅ #447 · C9 ✅ #472**.
**Drawer lane, in this order:** C3 → C6 → C7 → C8 (C10 needs one Jess call).
