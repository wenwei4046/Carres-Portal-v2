...
- Purchasing work uses the Operation Mon–Fri calendar. Warehouse/Receiving/GRN uses Mon–Sat.
  Sunday and Selangor public holidays are excluded; authoritative dates are never silently moved.
