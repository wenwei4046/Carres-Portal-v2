  ...
  return (
    <div className="bg-white border border-base-200 rounded-[4px] p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-label font-semibold uppercase tracking-[0.08em] text-red-600">
          Escalations
        </span>
        {items.length > 0 && (
          <span className="ml-auto text-label font-mono font-semibold text-red-600">
            {items.length}
          </span>
        )}
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-meta text-base-500 py-1">No escalations ✓</div>
      ) : (
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              >
                ...
                <p className="text-label text-base-600 mt-0.5 line-clamp-2">
                  {item.content}
                </p>
