...
/**
 * OrderCard — kanban tile for the OperationOrders pipeline view.
 *
 * Mirrors `reference/proto/operation-orders.jsx` lines 197-252 (the inner
...
function summariseThreadLps(
  ...
  const assigned = threads.filter(
    (t): t is operationOrderThreadRow & { delivery_partner_id: string } =>
...
export default function OrderCard({
  ...
  // non-null once operation issues a PO for that thread. Showing the count
