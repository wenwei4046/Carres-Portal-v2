 ...
 * tests migrated from `operationProcurement.test.tsx` when the legacy
...
describe("CreatePOModal — Suggest from alerts (T22)", () => {
  ...
  it("coalesces duplicate SKUs across warehouses + sums gaps (T42-pass3-C3)", async () => {
    // Codex pass-3 comment 3: `operation_stock_alerts()` returns one row per
 ...
 */
describe("CreatePOModal — base modal flows (migrated from operationProcurement)", () => {
 ...
 * (C5.3 → 5.2 chain) migrated from `operationProcurement.test.tsx`. The
