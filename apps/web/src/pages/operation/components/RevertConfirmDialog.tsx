 ...
 *
 * Wired to `/api/operation/orders/:id/revert-proceed` and
 * `/api/operation/orders/:id/revert-dispatch`. Server gates on
 * operation+principal; RPC also rechecks state so a stale UI can't force a
 * bad transition.
 */
