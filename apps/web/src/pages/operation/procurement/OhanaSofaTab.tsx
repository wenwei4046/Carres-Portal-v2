...
/**
 * OhanaSofaTab — Phase 4.5 Chunk 2 Sprint F Task 34.
 *
 ...
 * SKU starts with 'sofa:' — see `apps/api/src/routes/operation/procurement-tabs.ts`.
 */
export default function OhanaSofaTab() {
