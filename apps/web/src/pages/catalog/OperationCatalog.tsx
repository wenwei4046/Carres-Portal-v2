...
/**
 * OperationCatalog — single CRUD page for principal + operation to manage
 * the SKU catalog (Loo 2026-05-09 Q1=b, Q2=c, Q3=b, Q4=c). Mounted at
 * /operation/catalog and /principal/catalog; both routes render this same
 ...
 * so operation can fill them in before next PO.
 */
