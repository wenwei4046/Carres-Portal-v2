/**
 * Logistics KPI tile — clickable card with a 3px left accent bar, label,
 * big value, and a secondary hint line.
 *
 * Mirrors `reference/proto/logistics-dashboard.jsx` `KPI` (lines 64-72):
...
export default function LogisticsKpiTile({
  label,
  value,
  hint,
  accent,
