...
/**
 * Shared modal primitives used by the four logistics action modals
 * (Dispatch / DOAttach / IssuePOs / AbandonOrder). Centered overlay,
 * 560px default width, 4px corner radius. Matches `reference/proto/
 * logistics-orders.jsx` `Modal` (lines 530-543) and `ModalActions`
 * (lines 545-552).
 *
 * Accessibility:
 *   - Esc closes
...
/**
 * Shared input style helper — mirrors `reference/proto/logistics-orders.jsx`
