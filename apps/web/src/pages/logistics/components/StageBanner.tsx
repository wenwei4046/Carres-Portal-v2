...
/**
 * 2026-05-10 — Stage banner shown on `/logistics/orders/:stage`.
 *
 ...
 * the generic kanban hints in `LOGISTICS_FLOW.hint` because the stage page
 * has more vertical real-estate to explain ops responsibilities. Kept here
 * (not on LOGISTICS_FLOW) to avoid disturbing kanban tests that pin the
 * shorter copy.
 */
export const STAGE_DESCRIPTIONS: Record<LogisticsStage, string> = {
