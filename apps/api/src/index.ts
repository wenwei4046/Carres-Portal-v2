...
import principalOrdersRouter from "./routes/principal/orders";
import principalPartnersRouter from "./routes/principal/partners";
import principalStockRouter from "./routes/principal/stock";
import principalSuppliersRouter from "./routes/principal/suppliers";
...
api.route("/principal/orders", principalOrdersRouter);
api.route("/principal/partners", principalPartnersRouter);
api.route("/principal/stock", principalStockRouter);
api.route("/principal/suppliers", principalSuppliersRouter);
