...
/**
 * GET /api/operation/skus/:sku/recent-cost — Phase 4.5 Chunk 2 Sprint E Task 27.
 *
 ...
 *     control (operation + principal can SELECT both tables)
 ...
 *   state set by `operation_receive_po_with_do` (0045/0053) when every line
 ...
 *
 * Role gate: operation only — matches T18 stock-alerts + T19 thresholds
