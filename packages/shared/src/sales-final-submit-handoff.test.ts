...
/* ⚠️ These lookups are by NUMBER PREFIX, so they follow the file if it is ever
   renumbered — and this suite is why that matters. When main took 0391,
   0393/0394 and then 0395 first, these two migrations moved to 0396 and
   0397, and every
