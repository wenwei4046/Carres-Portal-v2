 ...
 *   - `contactNumber` → delivery_partners.contact (phone-only since 0048)
 *   - `address` → delivery_partners.address (dedicated column added by
 *     migration 0048 closing carry-forward `lp-address-column`)
