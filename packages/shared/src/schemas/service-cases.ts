 ...
 * (0287's CHECK makes them structurally non-optional in the row as well.)
 *
...
export const serviceCaseSchema = z.object({
  ...
  /**
   * S2 — the evidence ledger (migration 0287). Every file the case was filed
