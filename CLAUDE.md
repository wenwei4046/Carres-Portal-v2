...
| Web bundle | **built + deployed 2026-07-18 from main `fae896e` (New Order single-page raw form, PR #176; Pages deploy `26a8f049`, bundle `index-DULYQef0.js`); `SERVICE_ROLE` scan on dist = 0; canonical https://carres-portal.pages.dev live-verified (cache-busted).** bundle-size regression CF still open, see §17.5. |
| API bundle | **Deployed 2026-07-18 (Worker version `8c75d0e0-a531-4c47-ae7c-40cfd4fb9369`, PR #175 — New Order POS-parity: extended raw door incl. 0230 structured address; GET /api/catalog → 401 live-verified). Carries main through PR #173 (0230 structured address) + #175.** |
