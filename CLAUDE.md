...
| PO windows + supplier delay/day-before evidence | `docs/purchasing/MASTER.md` §§5.6.1, 5.7; Workspace §6; Orders charter; Stock §2; Delivery §1; COPY | **OWNER-APPROVED 2026-09-24 / NOT BUILT** | Batch demand into editable 11:30 and optional 16:00 standard windows on every Office working day (Jess 2026-09-25; the `PO Days` setting stays but gates nothing); supplier earlier cut-off wins. Default PO date is not confirmation. Delay requires reason, new date and WhatsApp screenshot; one-working-day-before asks for Supplier DO or exact-date confirmation. Preserve module boundaries. |
