...
| Web bundle | **built + deployed 2026-06-28 from main `a102042` (2990s Products P8 PWP+Promo, PR #45; Pages deploy `55d339dd`, bundle `index-B61GAs3h.js`); `SERVICE_ROLE` scan on dist = 0; canonical https://carres-portal.pages.dev live-verified.** bundle-size regression CF still open, see §17.5. |
| API bundle | **Deployed 2026-06-28 (Worker `350af70a-2a9f-4167-a92c-c355a64da651`, PR #45 — 2990s Products P8 PWP voucher + Promo, the FINAL phase; all DORMANT; GET /api/catalog → 401 live-verified). This deploy carries main's full P1–P8.** |
