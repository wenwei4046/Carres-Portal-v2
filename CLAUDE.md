...
| Web bundle | **built + deployed 2026-07-18 from main `039d33d` (New Order row-pick fills in place, PR #177; Pages deploy `4fe34290`, bundle `index-C4eUyuTn.js` — also carries PR #174 add-product P1); `SERVICE_ROLE` scan on dist = 0; canonical https://carres-portal.pages.dev live-verified (cache-busted).** bundle-size regression CF still open, see §17.5. |
