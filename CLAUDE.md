...
| Web bundle | **built + deployed 2026-07-19 (late) from main `6ceeeb48` (staff profile + one-step PIN + ENGLISH-ONLY UI sweep + centred staff page, PR #209; strict superset of same-day PR #210 dealer-POS-only + PR #208 bundle pricing; bundle `index-DDzoHDae.js`, deployed to BOTH Pages projects — carres-portal `9f57e2f5` + carres-pos `7db1b4b4`, `--branch=main`); `SERVICE_ROLE` scan on dist = 0; both pages.dev canonicals + pos./erp.carresofficial.com all live-verified (cache-busted).** bundle-size regression CF still open, see §17.5. |
