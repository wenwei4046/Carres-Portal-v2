...
| Work right panel — summary · one-line Order Route · Logistics / Customer / Supplier party cards · Owner, timing and source | `docs/workspace/MASTER.md` §§5.5, 5.9; Delivery §§5.2, 5.5; COPY "The Work Logistics card" + "The Work right panel words" | **OWNER-APPROVED 2026-09-25; Logistics BUILT (0581); the rest APPROVED TARGET, build in progress** | Left and middle are the deployed baseline. One card open at a time, one blue action, 72px collapsed cards, 743×704 acceptance. Who calls the customer follows `customer_contact_by`. Open items are §5.9's gap list. |
