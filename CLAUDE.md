...
| **Ready Stock K4 — pool usage reasons + reserve levels** (a DATED ledger, not 0213's undated column; the draw and the reason are one transaction across all THREE doors out of the pool; the level warns and never blocks) | ✅ LIVE | 2026-07-27 | PR #PENDING · 0292 + 0294 · `docs/ready-stock-execution-queue.md` |
