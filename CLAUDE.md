...
| Rental / Subscription | `docs/rental/MASTER.md` | **APPROVED / LOCKED** | Frozen agreement truth plus approved subscription service/visit target; initial Diglant factory holding + Carres-arranged pickup, short-term NETS for Klang Valley owner-confirmed 2026-09-22 (§4/§5.8), NOT BUILT. Regional volume, pickup frequency, complete delivery cost and service-performance reporting target approved (§5.8), NOT BUILT; remaining forecast blueprint is PROPOSAL / NOT LAW |
