...
| Web bundle | **built + deployed 2026-07-18 (post-#183 main — POS entry fixes + Add-product P1–P3 + staff PIN; several roll-forwards that day, FINAL bundle `index-BwAFO91J.js`); `SERVICE_ROLE` scan on dist = 0; canonical https://carres-portal.pages.dev + https://pos.carresofficial.com live-verified.** bundle-size regression CF still open, see §17.5. |
| API bundle | **Deployed 2026-07-18 (post-#183 main; FINAL Worker version `5dc3406a-4173-49f9-8299-9867150ab26a` — carries POS entry fixes [structured address + config-driven manual payment, PR #173 / 0230] + the full Add-product initiative P1–P3 [PRs #174/#179/#183, migrations 0231/0232/0233 on prod] + staff PIN; GET /api/catalog → 401 live-verified).** |
