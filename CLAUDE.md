...
| Web bundle | **built + deployed 2026-07-18 from main `673f299` (New Order row variants money-free, PR #180; Pages deploy `eafbdc28`, bundle `index-CIbQUc9h.js` — also carries add-product P2 [PR #179]); `SERVICE_ROLE` scan on dist = 0; canonical https://carres-portal.pages.dev live-verified (cache-busted).** bundle-size regression CF still open, see §17.5. |
| API bundle | **Deployed 2026-07-18 from main `673f299` (Worker version `15467bf2-b6b2-4340-8b94-8d79c47cc200` — carries the extended raw door [PR #175] + add-product P1+P2 [PRs #174/#179, migrations 0231/0232 verified on prod]; GET /api/catalog → 401 live-verified).** |
