...
| 2990s Products parity P4 (Maintenance pools) | 🔵 in progress | from 2026-06-26 | branch `feat/2990s-products-p4-maintenance-pools` · Brandings · Supplier-Categories · Bedframe/Mattress Sizes global option pools; versioned config-history layer DEFERRED. Plan `docs/superpowers/plans/2026-06-25-2990s-products-9tab-parity-roadmap.md` (P4 section). |
