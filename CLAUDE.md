...
| Manual Purchase create / returned-request edit | `docs/purchasing/MASTER.md` §9.2; COPY; UI MASTER split rule | **APPROVED / NOT BUILT, 2026-09-22** | Sales Order composition; `Request Details → Delivery → Items`, 50/50 internal MPR preview. Read the explicit approval/date boundaries; do not infer a supplier PO or a new finance gate. |
...
| Rental / Subscription | `docs/rental/MASTER.md` | **APPROVED / LOCKED** | Frozen agreement truth plus approved subscription service/visit target; initial Diglant factory holding + Carres-arranged pickup, short-term NETS for Klang Valley owner-confirmed 2026-09-22 (§4/§5.8), NOT BUILT. Regional volume, pickup frequency, complete delivery cost and service-performance reporting target approved (§5.8), NOT BUILT; advance PO before customer SO and existing-supply-first fulfilment and five-case SO supply handling approved (§4/§5.6), NOT BUILT; customer-receipt service start and service/recovery lifecycle approved 2026-09-23 (§5.9), NOT BUILT; remaining blueprint is PROPOSAL / NOT LAW |
