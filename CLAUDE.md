...
| Repair Orders business scope | `docs/purchasing/MASTER.md` §9.7; Stock §12.8; COPY | **APPROVED TARGET / NOT BUILT — 2026-09-18** | Direct inventory or Claim-linked RO; Warehouse/Showroom/Dealer including Display; actual Units and ownership authority required. Supplier Claim optional. Owner ruling 2026-09-19: optional price in RO create/detail; no financial placement/Issue gate; any required approval is Jess-only, no substitute. No automatic charge acceptance. Remaining UI is unapproved; read §9.7 before resuming. |
| Purchasing confirmed UI handoff — all six reviewed pages | `docs/purchasing/MASTER.md` §9.1–9.6; COPY and UI MASTER | **Confirmed decisions recorded on main; build status remains per page** | SO Batch #1459 merged; Manual design #1457 merged/build #1464 pending; PO specification synced from #1462, app pending; Receiving #1461 merged, its listing BUILT and DEPLOYED 2026-09-19 (#1467, `896a7b12`); a rendered walk 2026-09-19 found and fixed a 🔴 pinning defect (missing `min-w-0`), leaving only the real-data walk owed; Supplier Claims specification synced from #1463; Returns #1465 merged. Read current sections; do not restart design or revive older PR text. |
