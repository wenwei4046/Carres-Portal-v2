...
| Web bundle | **built + deployed 2026-07-19 from main `fcfaea6` (bundle pricing, PR #208; bundle `index-51dnmdW6.js`, deployed to BOTH Pages projects — carres-portal `0d48c842` + carres-pos `676edf32`, `--branch=main`; strict superset of the same-day `82be9bc` deploy, carries PR #204/#206/#207 too); `SERVICE_ROLE` scan on dist = 0; both pages.dev canonicals live-verified (cache-busted).** bundle-size regression CF still open, see §17.5. |
