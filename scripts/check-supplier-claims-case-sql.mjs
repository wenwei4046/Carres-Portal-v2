...
assert.deepEqual(dmgRow.evidence,[{slot:'receiving_photo',path:'claims/a1.jpg',kind:'photo',at:'2026-09-06T01:00:00Z',by:reporter,bucket:'delivery-orders'}]);
...
const rptPayload={reported_by:'showroom',product_category:'mattress',issue_type:'damaged',what_happened:'Same torn corner seen at handover',unit_code:'id-aaa000001',receiving_unit_result_id:occ[0].receiving_unit_result_id,evidence:[{slot:'overall_photo',path:`draft/${rpt}/again.jpg`}]};
